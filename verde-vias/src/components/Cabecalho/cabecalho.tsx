...
export default function Cabecalho() {
    return (
        <div className="h-screen">
            <div className="mt-36 flex flex-col md:flex-row items-center justify-between text-center lg:justify-around ">
                ...
                <Image width={500} src={Transporte} alt="Pessoa entrando no transporte"></Image>
            </div>
        </div>
    )
}